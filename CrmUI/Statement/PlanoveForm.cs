...
{
    public partial class PlanoveForm<T> : Form where T : class
    {
        CrmContext db;
        DbSet<T> set;
        ...
        private void Show_Click(object sender, EventArgs e)
        {
            ...
            {
                if (comboBox2.Text != dataGridView1.Rows[i].Cells[0].Value.ToString())
                {
                    if (comboBox1.Text != dataGridView1.Rows[i].Cells[1].Value.ToString())
                    {
                        if (comboBox3.Text != dataGridView1.Rows[i].Cells[2].Value.ToString())
                        {
        ...
        private void PlanoveForm_Load(object sender, EventArgs e)
        {
            List<Teacher> teachers = db.Teachers.ToList(); //принимаем данные с таблицы групп
