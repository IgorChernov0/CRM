...
{
    public partial class Cvartal : Form
    {
        public Cvartal()
        {
            InitializeComponent();
        ...
        private void Show_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                if (numericUpDown1.Text != dataGridView1.Rows[i].Cells[0].Value.ToString())
                {
                    if (comboBox2.Text != dataGridView1.Rows[i].Cells[1].Value.ToString())
                    {
                        if (numericUpDown1.Text == "" || comboBox2.Text == "")
                        {
                ...
                for (int c = 0; c < dataGridView1.Columns.Count; c++)
                {
                    ...
                    if (dataGridView1[c, i].Value.ToString() == numericUpDown1.Text)
                    {
                        if (comboBox2.Text == dataGridView1.Rows[i].Cells[1].Value.ToString())
                            exist = true;
                        break;
